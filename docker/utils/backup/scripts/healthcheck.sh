...
command -v mariadb-dump >/dev/null 2>&1 || { echo "ERROR: mariadb-dump not found"; exit 1; }
...
mariadb-dump --version >/dev/null 2>&1 || { echo "ERROR: mariadb-dump execution failed"; exit 1; }
