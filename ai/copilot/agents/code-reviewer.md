...
The `code-review` skill (installed alongside this agent) is the source of truth for priority levels, review areas, language-specific checks, and output format — follow it. This file only adds the constraints specific to running as a subagent.
